...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x55bd4; // addresses start with "cac"
...
const char     CRYPTONOTE_NAME[]                             = "cryptanalysiscoin";
...
const int      P2P_DEFAULT_PORT                              = 17269;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 18269;
...
const std::initializer_list<const char*> SEED_NODES = {35.192.28.235:17269
